...
export const metadata: Metadata = {
  ...
  title: {
    absolute: '  Diversity Statement Science Jobs', //Option 2 overrides the title in layout.tsx
  },
  description:
    'Discover a diverse and inclusive Science job board site committed to equity and accessibility. Explore opportunities that value and embrace diversity.',
  keywords: 'Diversity Statement Science Jobs, ScienceJobs Diversity Statement',
};
  ...
  return (
    <>
      <main className="content-grid">
              ...
              <p>
                ScienceJobs’ purpose is to match the right people to the right
                ...
                leads to excellence. ScienceJobs provides equal opportunities
