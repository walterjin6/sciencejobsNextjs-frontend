...
import FAQ from '@/components/FAQ';
  ...
  export const metadata: Metadata = {
    ...
    title: {
      absolute: 'FAQ Academic Jobs Australia', //Option 2 overrides the title in layout.tsx
    },
    description:
      'Search for academic jobs at all Australian universities today! Explore your next academic positions through visiting our higher ed jobs, with new academic jobs added daily.',
    keywords: 'FAQ academicjobs Australia, academicjobs Australia FAQ, Frequently Asked Questions Australia',
  };
