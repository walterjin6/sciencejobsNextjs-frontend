      ...
      <div className="container lg:max-w-screen-lg px-4 mx-auto ">
        <form onSubmit={handleFormSubmit}>
          <div className="join mx-auto w-full border border-gray-200 shadow-md flex flex-col md:flex-row">
            ...
            <button
              type="submit"
              className="indicator md:w-fit w-full bg-[#00aeef] md:bg-0 justify-center items-center animate-pulse"
            >
              <div className="btn join-item bg-[#00aeef] md:border md:border-gray-300 md:shadow-md border-0 text-white animate-pulse ">
                Search
              </div>
            </button>
          </div>
